...
<%@ page import="com.ls.common.User" %>
<%@ page import="com.ls.common.Teacher" %>
<HTML>
<head>
    <%
...
<jsp:useBean id="teacherHandle" class="com.ls.common.TeacherHandle" >
</jsp:useBean>
<h1 class="text-center">教师列表</h1>
<table align="center" class="table table-hover table table-striped table-condensed">
    ...
    <%
        ArrayList<Teacher> teacherList = teacherHandle.getAllTeacher();
    ...
    <tr class="table-light">
        ...
        <td><a href="/DeleteServlet?id=<%=teacher.getId()%>">删除</a>|<a href="updateUser.jsp?id=<%=teacher.getId()%>">修改</a> </td>
    </tr>
    <%
        }
    %>
