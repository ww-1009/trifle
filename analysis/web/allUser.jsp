...
<jsp:useBean id="userHandle" class="com.ls.common.UserHandle" >
</jsp:useBean>
...
<table align="center" class="table table-hover table table-striped table-condensed">
    ...
    <%
        ArrayList<User> userList = userHandle.getAllUsers();
    ...
    <tr class="table-light">
        ...
        <td><a href="DeleteServlet?id=<%=user.getId()%>">删除</a>|<a href="updateUser.jsp?id=<%=user.getId()%>">修改</a> </td>
    </tr>
    <%
        }
    %>
